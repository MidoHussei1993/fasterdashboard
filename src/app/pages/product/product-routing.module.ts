...
const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: ':productId/details/view/:id',
       component: ProductDetailsCrudComponent , 
       data: {mode: FormMode.View}
      },
      { 
      ...
      //  data: {mode: FormMode.Create}
       },
       {
        ...
        loadChildren: () =>
          import('./product-additional-options/product-additional-options.module').then((m) => m.ProductAdditionalOptionsModule),
      },
      {
        path: 'components/:detailsId',
        loadChildren: () =>
          import('./product-compone/product-compone.module').then((m) => m.ProductComponeModule),
      },
      {
        path: 'size-details/:detailsId',
        loadChildren: () =>
          import('./product-details-size/product-details-size.module').then((m) => m.ProductDetailsSizeModule),
      },
    ],
  },
];
