...
@Component({
  selector: 'app-closed-delivery-order',
  templateUrl: './closed-delivery-order.component.html',
  styleUrls: ['./closed-delivery-order.component.scss'],
})
export class ClosedDeliveryOrderComponent implements OnInit {
  ...
  DeliveryOrderDataReport() {
    ...
    this.spinner.show();
    this.reportServices
      .ClosedDeliveryOrderDataListReport(this.filter)
      .subscribe(
