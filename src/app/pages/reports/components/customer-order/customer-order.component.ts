...
export class CustomerOrderComponent implements OnInit {
  ...
  DeliveryOrderDataReport(filter: OrderReportFilter) {
    ...
    this.filter.CustomerId = this.route.snapshot.params.id;
    this.spinner.show();
  ...
  downloadAll() {
    ...
    downloadFilter.CustomerId = this.route.snapshot.params.id;
    this.spinner.show();
  ...
  getTransportOrderDataReport(transportFilter: OrderReportFilter) {
    this.busyLoading = true;
    this.spinner.show();
    transportFilter.CustomerId = this.route.snapshot.params.id;
  ...
  transportDownloadAll() {
    ...
    downloadtransportFilter.CustomerId = this.route.snapshot.params.id;
