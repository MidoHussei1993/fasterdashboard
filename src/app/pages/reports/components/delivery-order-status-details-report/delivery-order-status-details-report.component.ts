...
@Component({
  selector: 'app-delivery-order-status-details-report',
  templateUrl: './delivery-order-status-details-report.component.html',
  styleUrls: ['./delivery-order-status-details-report.component.scss']
})
export class DeliveryOrderStatusDetailsReportComponent implements OnInit {
  ...
  getcobonetransport(filter: TransportStatusOrderFilter) {
    ...
    this.reportServices.deliveryorderStatus(id, filter).subscribe((res: List<CoboneTrasport>) => {
