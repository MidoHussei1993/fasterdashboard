...
import { isVender, isShop } from 'src/app/util/access-storge';
import { OrderReport, OrderReportFilter } from '../../model';
import { DeliveryOrderService } from '../../services/delivery-order.service';
import { ReportsService } from '../../services/reports.service';

@Component({
  selector: 'app-open-delivery-order',
  templateUrl: './open-delivery-order.component.html',
  styleUrls: ['./open-delivery-order.component.scss'],
})
export class OpenDeliveryOrderComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.headerService.setPageTitle(this.translate.instant('menu.openOrders'));
  ...
  DeliveryOrderDataReport() {
    ...
    this.spinner.show();
    this.reportServices.OpenDeliveryOrderDataListReport(this.filter).subscribe(
