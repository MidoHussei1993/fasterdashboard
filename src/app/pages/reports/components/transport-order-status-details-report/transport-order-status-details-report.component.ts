...
@Component({
  selector: 'app-transport-order-status-details-report',
  templateUrl: './transport-order-status-details-report.component.html',
  styleUrls: ['./transport-order-status-details-report.component.scss']
})
export class TransportOrderStatusDetailsReportComponent implements OnInit {
  ...
  getcobonetransport(filter:OrderFilter){
    ...
    this.reportServices.TransportOrderStatusReport(filter).subscribe((res:List<DeliveryOrderStatus>) =>{
